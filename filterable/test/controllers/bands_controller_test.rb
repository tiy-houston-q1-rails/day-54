...
class BandsControllerTest < ActionController::TestCase
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post :create, band: { first_album_year: @band.first_album_year, name: @band.name, origin: @band.origin }
    end
  ...
  test "should update band" do
    patch :update, id: @band, band: { first_album_year: @band.first_album_year, name: @band.name, origin: @band.origin }
    assert_redirected_to band_path(assigns(:band))
  end
